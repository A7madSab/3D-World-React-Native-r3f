  ...
  useEffect(() => {
    if (transformRef.current) {
      ...
      const callback = event => {
        ...
        store.dispatch(updateMesh(store.getState().meshReducer.selectedMesh.id, { ...store.getState().meshReducer.selectedMesh, position: [mesh.position.x, mesh.position.y, mesh.position.z] }))
      }
